...
export const GEO_EMPTY = { empty: 'Este endereço não existe.' };
...
export const POC_EMPTY = { empty: 'Não há PoC para este endereço.' };
...
export const PRODUCT_EMPTY = { empty: 'Não há produtos para este PoC' };
